                ...
                <div class="task-content">
                    ...
                    <div class="task-comments">
                        ...
                        <div class="comment-commands">
                            <div class="create-comment" @click="addFastComment(index)"><?= file_get_contents('static/images/Add.svg');?></div>
                            <div class="delete-comment" @click="deleteTaskModal(index,todos[index].id)"><?= file_get_contents('static/images/Delete.svg');?></div>
                            <div class="update-comment" @click="updateTaskModal(index)"><?= file_get_contents('static/images/Update.svg');?></div>
                        </div>
                    </div>
                </div>
            </div>
